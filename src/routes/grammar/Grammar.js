      ...
      <div className="grammars__levels">
        <div className="degree__block1">
          ...
          <div className="degree_a1">
            ...
            <p className="degree_description">At the end of this level, you’ll feel more confident in everyday conversations, will have better communication skills, and will know more vocabulary.</p>
          ...
          <img src={A2Level} alt="" className="degree_img" />
            ...
            <p className="degree_description">Thanks to this level, you’ll be able to communicate simply in everyday situations where English is spoken.</p>
            <Link to="/" >  <button className="degree_starting__btn">Start Learning</button> </Link>
        ...
        <div className="degree_block2">
          ...
          <img src={B2Level} alt="" className="degree_img" />
            ...
            <p className="degree_description">You’ll be able to achieve a greater understanding of the main points in complex texts and speeches. You’ll be more autonomous in your use of the language.</p>
            <Link to="/" >  <button className="degree_starting__btn">Start Learning</button> </Link>
          </div>
          ...
          <img src={B2_C1Level} alt="" className="degree_img" />
            ...
            <p className="degree_description">With this level, you’ll reach a greater degree of fluency that will allow you to communicate with native speakers. You’ll have a superior level of English comprehension.</p>
            <Link to="/" >  <button className="degree_starting__btn">Start Learning</button> </Link>
          </div>
          ...
          <img src={C1Level} alt="" className="degree_img" />
            ...
            <p className="degree_description">You’ll improve your use of the language, feel more comfortable, and increase your vocabulary with a special focus on business. </p>
            <Link to="/" >  <button className="degree_starting__btn">Start Learning</button> </Link>
          </div>
        </div>
      </div>
