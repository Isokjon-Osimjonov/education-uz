...
<div className="home__welcome">
  ...
  <p className="welcome__description">  Learn English online and improve your skills through our high-quality courses and resources – all designed for adult language learners. Everything you find here has been specially created by the Edu-Uz LearnEnglish, the world's English teaching experts.</p>
</div>

<div className="auto__typing">
<h1 className="auto__typing__title"> 
You Can With Us - <span className="typwriter__title"> <Typewriter 
